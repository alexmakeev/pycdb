    ...
    def __init__(self):
        ...
        base_attributes_top = [
            ...
            makeAttribute("name", "Unique API Name", "For automated scripts, should be permanent", self.TYPE_STRING,
                          ""),
            makeAttribute("description", "Description", "Additional information and comments", self.TYPE_STRING,
                          "No description"),
        ]
        ...
        self.addEntityClass(5, "device", "Device", "", base_attributes_top + [
            ...
            makeAttribute("init_str", "Initialize String", "String to initialize the Device by the driver",
                          self.TYPE_STRING, ""),
            makeAttribute("sequence_number", "Sequence Number", "Sequence number for sorting devices during export",
                          self.TYPE_INTEGER, ""),
            makeAttribute("bigc_info", "Big Channel Info", "Big channel information [should be temporal]",
                          self.TYPE_TEXT, ""),
        ...
        self.addEntityClass(6, "device_channel", "Device Channel", "", base_attributes_top + [
            makeAttribute("group_num", "Group Number",
                          "Address of Channel group at Device channel groups (by its Device Type)",
                          self.TYPE_INTEGER, ""),
            makeAttribute("needs_init", "Needs Initialization", "Is the initialization required by the channel or not",
                          self.TYPE_INTEGER, ""),
            makeAttribute("init_value", "Initialization Value", "The Value to be used if initialization is needed",
                          self.TYPE_TEXT, ""),
        ] + base_attributes_bottom)
