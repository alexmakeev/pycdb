...
class NSLS2Magnets(Configuration):
    def __init__(self):
        ...
        self.addEntityClass(2, "ioc", "IOC", "", base_attributes_top + [
            makeAttribute("template", "Template", "Template file for generating IOC's config", self.TYPE_STRING,
                          "ioc.tmpl"),
        ] + base_attributes_bottom)
        ...
        self.addEntityClass(4, "device_type", "Device Type", "", base_attributes_top + [
            makeAttribute("params", "Parameters", "A set of device type parameters", self.TYPE_DICTIONARY,
                          {"PSy": "BR"}),
            makeAttribute("template", "Template", "Template dir name to use for generating IOC's config",
                          self.TYPE_STRING, ""),
        ] + base_attributes_bottom)
