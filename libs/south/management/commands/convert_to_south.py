...
class Command(BaseCommand):
    ...
    help = "Quickly converts the named application to use South if it is currently using zsyncdb."
    ...
    def handle(self, app=None, *args, **options):
        ...
        if not model_list:
            print "This application has no models; this command is for applications that already have models zsyncdb'd."
        ...
        print "(i.e. you haven't changed it since last zsyncdb); if you have, you should delete the %s/migrations" % app
