...
def bipartite_configuration_model(aseq, bseq, create_using=None, seed=None):
    """Return a random bipartite nxgraph from two given degree sequences.
    ...
    create_using : NetworkX nxgraph instance, optional
       Return nxgraph of this type.
    ...
    If no nxgraph type is specified use MultiGraph with parallel edges.
    If you want a nxgraph with no parallel edges use create_using=Graph()
...
def bipartite_havel_hakimi_graph(aseq, bseq, create_using=None):
    """Return a bipartite nxgraph from two given degree sequences using a
...
def bipartite_alternating_havel_hakimi_graph(aseq, bseq,create_using=None):
    """Return a bipartite nxgraph from two given degree sequences using
...
def bipartite_preferential_attachment_graph(aseq,p,create_using=None,seed=None):
    """Create a bipartite nxgraph with a preferential attachment model from
...
def bipartite_random_graph(n, m, p, seed=None, directed=False):
    """Return a bipartite random nxgraph.

    This is a bipartite version of the binomial (Erdős-Rényi) nxgraph.
    ...
    Notes
    -----
    The bipartite random nxgraph algorithm chooses each of the n*m (undirected)
