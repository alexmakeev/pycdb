...
def gn_graph(n,kernel=None,create_using=None,seed=None):
    ...
    The nxgraph is always a (directed) tree.

    Parameters
    ----------
    n : int
        The number of nodes for the generated nxgraph.
    kernel : function
        The attachment kernel.
    create_using : nxgraph, optional (default DiGraph)
    ...
    Examples
    --------
    >>> D=nx.gn_graph(10)    # the GN nxgraph
...
def gnr_graph(n,p,create_using=None,seed=None):
    ...
    instead "redirected" to the successor node of the target.  The nxgraph is
    ...
    Examples
    --------
    >>> D=nx.gnr_graph(10,0.5)  # the GNR nxgraph
    >>> G=D.to_undirected()  # the undirected version
...
def scale_free_graph(n,
                     ...
                     create_using=None,
                     seed=None):
    """Return a scale free directed nxgraph.

    Parameters
    ----------
    n : integer
        Number of nodes in nxgraph
    alpha : float 
    ...
    create_using : nxgraph, optional (default MultiDiGraph)
        Use this nxgraph instance to start the process (default=3-cycle).
