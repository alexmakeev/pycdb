...
def configuration_model(deg_sequence, create_using=None, seed=None):
    """Return a random nxgraph with the given degree sequence.

    The configuration model generates a random pseudograph (nxgraph with
    ...
    create_using : nxgraph, optional (default MultiGraph)
       Return nxgraph of this type. The instance will be cleared.
    ...
    -------
    G : MultiGraph
        A nxgraph with the specified degree sequence.
    ...
    nxgraph) is allowed since this function returns graphs with self
    loops and parallel edges.  An exception is raised if the degree
    sequence does not have an even sum.

    This configuration model construction process can lead to
    duplicate edges and loops.  You can remove the self-loops and
    parallel edges (see below) which will likely result in a nxgraph
    that doesn't have the exact degree sequence specified.  This
    "finite-size effect" decreases as the size of the nxgraph increases.
    ...
    # start with empty N-node nxgraph
    N = len(deg_sequence)
...
def directed_configuration_model(in_degree_sequence,
    ...
    """Return a directed_random nxgraph with the given degree sequences.

    The configuration model generates a random directed pseudograph
    (nxgraph with parallel edges and self loops) by randomly assigning
    ...
    create_using : nxgraph, optional (default MultiDiGraph)
       Return nxgraph of this type. The instance will be cleared.
    seed : hashable object, optional
        Seed for random number generator.
    ...
    -------
    G : MultiDiGraph
        A nxgraph with the specified degree sequences.
        Nodes are labeled starting at 0 with an index
        corresponding to the position in deg_sequence.
    ...
    Examples
    --------
    >>> D=nx.DiGraph([(0,1),(1,2),(2,3)]) # directed path nxgraph
...
def expected_degree_graph(w, seed=None, selfloops=True):
    r"""Return a random nxgraph with given expected degrees.
    ...
    Set selfloops=False to produce a nxgraph without self loops.
...
def havel_hakimi_graph(deg_sequence, create_using=None):
    """Return a simple nxgraph with given degree sequence constructed
    ...
    create_using : nxgraph, optional (default Graph)
        Return nxgraph of this type. The instance will be cleared.
    ...
    NetworkXException
        ...
        not realizable by some simple nxgraph).

    Notes
    -----
    The Havel-Hakimi algorithm constructs a simple nxgraph by
    successively connecting the node of highest degree to other nodes
    of highest degree, resorting remaining nodes by degree, and
    repeating the process. The resulting nxgraph has a high
    ...
    if create_using is not None:
        ...
        if create_using.is_multigraph():
            raise nx.NetworkXError("Havel-Hakimi requires simple nxgraph")
...
def random_degree_sequence_graph(sequence, seed=None, tries=10):
    r"""Return a simple random nxgraph with the given degree sequence.
    ...
    seed : hashable object, optional
        Seed for random number generator
    tries : int, optional
        Maximum number of tries to create a nxgraph
    ...
    NetworkXError
        If a nxgraph is not produced in specified number of tries
    ...
    Notes
    -----
    The generator algorithm [1]_ is not guaranteed to produce a nxgraph.
    ...
    for try_n in range(tries):
        try:
            ...
            pass
    raise nx.NetworkXError('failed to generate nxgraph in %d tries' % tries)
...
class DegreeSequenceRandomGraph(object):
    ...
    def generate(self):
        ...
        if len(self.remaining_degree) > 0:
            # build nxgraph in three phases according to how many unmatched edges
            self.phase1()
            self.phase2()
            self.phase3()
        return self.graph
    ...
    def update_remaining(self, u, v, aux_graph=None):
        # decrement remaining nodes, modify auxilliary nxgraph if in phase3
        if aux_graph is not None:
            # remove edges from auxilliary nxgraph
    ...
    def suitable_edge(self):
        # Check if there is a suitable edge that is not in the nxgraph
    ...
    def phase3(self):
        ...
        # build auxilliary nxgraph of potential edges not already in nxgraph
