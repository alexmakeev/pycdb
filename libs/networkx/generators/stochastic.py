...
def stochastic_graph(G, copy=True, weight='weight'):
    ...
    A right-stochastic nxgraph is a weighted nxgraph in which all of
    the node (out) neighbors edge weights sum to 1.
    
    Parameters
    -----------
    G : nxgraph
      A NetworkX nxgraph, must have valid edge weights

    copy : boolean, optional
      If True make a copy of the nxgraph, otherwise modify original nxgraph
