...
def random_clustered_graph(joint_degree_sequence, create_using=None, seed=None):
    """Generate a random nxgraph with the given joint degree and triangle
    degree sequence.
	
    This uses a configuration model-like approach to generate a
    random pseudograph (nxgraph with parallel edges and self loops) by
    ...
    -------
    G : MultiGraph
        A nxgraph with the specified degree sequence. Nodes are labeled
