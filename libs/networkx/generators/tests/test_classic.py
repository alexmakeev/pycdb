...
Unit tests for various classic nxgraph generators in generators/classic.py
"""
...
class TestGeneratorClassic():
    ...
    def test_barbell_graph(self):
        ...
        # number of edges = 2*(number_of_edges(m1-complete nxgraph) + m2 + 1
        m1 = 3;
        m2 = 5
    ...
    def test_complete_graph(self):
        # complete_graph(m) is a connected nxgraph with
    ...
    def test_complete_bipartite_graph(self):
        ...
        # complete_bipartite_graph(m1,m2) is a connected nxgraph with
    ...
    def test_empty_graph(self):
        ...
        # create empty nxgraph from another
        pete = petersen_graph()
    ...
    def test_grid_graph(self):
        """grid_graph([n,m]) is a connected simple nxgraph with the
