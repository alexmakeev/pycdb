...
def make_small_undirected_graph(graph_description, create_using=None):
    """
    Return a small undirected nxgraph described by graph_description.
...
def make_small_graph(graph_description, create_using=None):
    """
    Return the small nxgraph described by graph_description.

    graph_description is a list of the form [ltype,name,n,xlist]

    Here ltype is one of "adjacencylist" or "edgelist",
    name is the name of the nxgraph and n the number of nodes.
    This constructs a nxgraph of n nodes with integer labels 0,..,n-1.
    
    If ltype="adjacencylist"  then xlist is an adjacency list
    with exactly n entries, in with the j'th entry (which can be empty)
    specifies the nodes connected to vertex j.
    e.g. the "square" nxgraph C_4 can be obtained by
    ...
    Use the create_using argument to choose the nxgraph class/type.
    """
...
def LCF_graph(n,shift_list,repeats,create_using=None):
    """
    Return the cubic nxgraph specified in LCF notation.
    ...
    n (number of nodes)
      The starting nxgraph is the n-cycle with nodes 0,...,n-1.
      (The null nxgraph is returned if n < 0.)
...
def cubical_graph(create_using=None):
    """Return the 3-regular Platonic Cubical nxgraph."""
    description=[
        "adjacencylist",
...
def desargues_graph(create_using=None):
    """ Return the Desargues nxgraph."""
    G=LCF_graph(20, [5,-5,9,-9], 5, create_using)
    G.name="Desargues Graph"
    return G

def diamond_graph(create_using=None):
    """Return the Diamond nxgraph. """
    description=[
        "adjacencylist",
        "Diamond Graph",
        4,
...
def dodecahedral_graph(create_using=None):
    """ Return the Platonic Dodecahedral nxgraph. """
...
def frucht_graph(create_using=None):
    ...
    The Frucht Graph is the smallest cubical nxgraph whose
...
def heawood_graph(create_using=None):
    """ Return the Heawood nxgraph, a (3,6) cage. """
    G=LCF_graph(14, [5,-5], 7, create_using)
    G.name="Heawood Graph"
    return G

def house_graph(create_using=None):
    """Return the House nxgraph (square with triangle on top)."""
    description=[
        "adjacencylist",
        "House Graph",
        5,
...
def house_x_graph(create_using=None):
    """Return the House nxgraph with a cross inside the house square."""
    description=[
        "adjacencylist",
...
def icosahedral_graph(create_using=None):
    """Return the Platonic Icosahedral nxgraph."""
    description=[
        "adjacencylist",
...
def moebius_kantor_graph(create_using=None):
    """Return the Moebius-Kantor nxgraph."""
    G=LCF_graph(16, [5,-5], 8, create_using)
    G.name="Moebius-Kantor Graph"
    return G    

def octahedral_graph(create_using=None):
    """Return the Platonic Octahedral nxgraph."""
    description=[
        "adjacencylist",
...
def pappus_graph():
    """ Return the Pappus nxgraph."""
    G=LCF_graph(18,[5,7,-7,7,-7,-5],3)
    G.name="Pappus Graph"
    return G

def petersen_graph(create_using=None):
    """Return the Petersen nxgraph."""
    description=[
        "adjacencylist",
        "Petersen Graph",
        10,
...
def tetrahedral_graph(create_using=None):
    """ Return the 3-regular Platonic Tetrahedral nxgraph."""
    G=complete_graph(4, create_using)
    G.name="Platonic Tetrahedral nxgraph"
    return G
