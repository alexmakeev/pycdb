...
def draw(G, pos=None, ax=None, hold=None, **kwds):
    """Draw the nxgraph G with Matplotlib (pylab).

    Draw the nxgraph as a simple representation with no node
    ...
    ax : Matplotlib Axes object, optional
       Draw the nxgraph in specified Matplotlib axes.
...
def draw_networkx(G, pos=None, with_labels=True, **kwds):
    """Draw the nxgraph G using Matplotlib.

    Draw the nxgraph with Matplotlib with options for node positions,
    ...
    ax : Matplotlib Axes object, optional
       Draw the nxgraph in the specified Matplotlib axes.
...
def draw_networkx_nodes(G, pos,
                        ...
                        label=None,
                        **kwds):
    """Draw the nodes of the nxgraph G.

    This draws only the nodes of the nxgraph G.
...
def draw_networkx_edges(G, pos,
                        ...
                        label=None,
                        **kwds):
    """Draw the edges of the nxgraph G.

    This draws only the edges of the nxgraph G.
...
def draw_networkx_labels(G, pos,
                         ...
                         ax=None,
                         **kwds):
    """Draw node labels on the nxgraph G.
...
def draw_circular(G, **kwargs):
    """Draw the nxgraph G with a circular layout."""
    draw(G, circular_layout(G), **kwargs)


def draw_random(G, **kwargs):
    """Draw the nxgraph G with a random layout."""
    draw(G, random_layout(G), **kwargs)


def draw_spectral(G, **kwargs):
    """Draw the nxgraph G with a spectral layout."""
    draw(G, spectral_layout(G), **kwargs)


def draw_spring(G, **kwargs):
    """Draw the nxgraph G with a spring layout."""
    draw(G, spring_layout(G), **kwargs)


def draw_shell(G, **kwargs):
    """Draw networkx nxgraph with shell layout."""
...
def draw_graphviz(G, prog="neato", **kwargs):
    """Draw networkx nxgraph with graphviz layout."""
