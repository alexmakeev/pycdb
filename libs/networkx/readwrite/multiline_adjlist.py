...
simple edge data can be stored but node or nxgraph data is not.
...
That pattern repeats for all nodes in the nxgraph.

The nxgraph with edges a-b, a-c, d-e can be represented as the following
...
def generate_multiline_adjlist(G, delimiter=' '):
    """Generate a single line of the nxgraph G in multiline adjacency list format.
...
def write_multiline_adjlist(G, path, delimiter=' ',
    ...
    """ Write the nxgraph G in multiline adjacency list format to path
...
def parse_multiline_adjlist(lines, comments='#', delimiter=None,
                            ...
                            edgetype=None):
    """Parse lines of a multiline adjacency list representation of a nxgraph.
    ...
    create_using: NetworkX nxgraph container
       Use given NetworkX nxgraph for holding nodes or edges.
    ...
    -------
    G: NetworkX nxgraph
        The nxgraph corresponding to the lines in multiline adjacency list format.
...
def read_multiline_adjlist(path, comments="#", delimiter=None,
                           ...
                           encoding='utf-8'):
    """Read nxgraph in multi-line adjacency list format from path.
    ...
    The optional create_using parameter is a NetworkX nxgraph container.
    The default is Graph(), an undirected nxgraph.  To read the data as
    a directed nxgraph use

    >>> G=nx.read_multiline_adjlist("test.adjlist", create_using=nx.DiGraph())
    
    Notes
    -----
    This format does not store nxgraph, node, or edge data.
