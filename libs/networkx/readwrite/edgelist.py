...
def generate_edgelist(G, delimiter=' ', data=True):
    """Generate a single line of the nxgraph G in edge list format.
...
def write_edgelist(G, path, comments="#", delimiter=' ', data=True,
                   encoding = 'utf-8'):
    """Write nxgraph as a list of edges.
...
def parse_edgelist(lines, comments='#', delimiter=None,
    ...
    """Parse lines of an edge list representation of a nxgraph.


    Returns
    -------
    G: NetworkX Graph
        The nxgraph corresponding to lines
    data : bool or list of (label,type) tuples
       If False generate no edge data or if True use a dictionary 
       representation of edge data or a list tuples specifying dictionary 
       key names and types for edge data.
    create_using: NetworkX nxgraph container, optional
    ...
    if create_using is None:
        ...
        try:
            ...
            raise TypeError("create_using input is not a NetworkX nxgraph type")
...
def read_edgelist(path, comments="#", delimiter=None, create_using=None, 
    ...
    """Read a nxgraph from a list of edges.
    ...
    create_using : Graph container, optional, 
       Use specified container to build nxgraph.  The default is networkx.Graph,
...
def write_weighted_edgelist(G, path, comments="#", 
    ...
    """Write nxgraph G as a list of edges with numeric weights.
...
def read_weighted_edgelist(path, comments="#", delimiter=None,
    ...
    """Read a nxgraph as list of edges with numeric weights.
