...
def generate_pajek(G):
    """Generate lines in Pajek nxgraph format.
...
def write_pajek(G, path, encoding='UTF-8'):
    """Write nxgraph in Pajek format to path.
...
def read_pajek(path, encoding='UTF-8'):
    """Read nxgraph in Pajek format from path.
...
def parse_pajek(lines):
    """Parse Pajek format nxgraph from string or iterable.
