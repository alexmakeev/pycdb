...
are considered target nodes and are added to the nxgraph along with an edge
...
def parse_adjlist(lines, comments = '#', delimiter = None,
    ...
    -------
    G: NetworkX nxgraph
        The nxgraph corresponding to the lines in adjacency list format.
...
def read_adjlist(path, comments="#", delimiter=None, create_using=None, 
    ...
    Notes
    -----
    This format does not store nxgraph or node data.
