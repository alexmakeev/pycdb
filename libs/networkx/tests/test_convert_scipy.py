...
class TestConvertNumpy(object):
    ...
    def test_identity_graph_matrix(self):
        "Conversion from nxgraph to sparse matrix to nxgraph."
    ...
    def test_identity_weighted_graph_matrix(self):
        """Conversion from weighted nxgraph to sparse matrix to weighted nxgraph."""
    ...
    def test_nodelist(self):
        """Conversion from nxgraph to sparse matrix to nxgraph with nodelist."""
        P4 = path_graph(4)
        P3 = path_graph(3)
        nodelist = P3.nodes()
