...
A nxgraph is chordal if every cycle of length at least 4 has a chord
...
def is_chordal(G):
    """Checks whether G is a chordal nxgraph.
    ...
    -------
    chordal : bool
      True if G is a chordal nxgraph and False otherwise.
    
    Raises
    ------
    NetworkXError
        The algorithm does not support DiGraph, MultiGraph and MultiDiGraph. 
        If the input nxgraph is an instance of one of these classes, a
...
def find_induced_nodes(G, s, t, treewidth_bound=sys.maxsize):
    ...
    ----------
    G : nxgraph
      A chordal NetworkX nxgraph
    s : node
	Source node to look for induced nodes
    t : node
	Destination node to look for induced nodes
    treewith_bound: float
        Maximum treewidth acceptable for the nxgraph H. The search
    ...
    NetworkXError
        ...
        the input nxgraph is found to be non-chordal, a NetworkXError is raised.
    ...
    Notes
    -----
    G must be a chordal nxgraph and (s,t) an edge that is not in G.
    ...
    """
    if not is_chordal(G):
        raise nx.NetworkXError("Input nxgraph is not chordal.")
...
def chordal_graph_cliques(G):
    """Returns the set of maximal cliques of a chordal nxgraph.
    
    The algorithm breaks the nxgraph in connected components and performs a
    ...
    NetworkXError
        ...
        input nxgraph is found to be non-chordal, a NetworkXError is raised.
...
def chordal_graph_treewidth(G):
    """Returns the treewidth of the chordal nxgraph G.
    ...
    -------
    treewidth : int
	The size of the largest clique in the nxgraph minus one.
...
def _is_complete_graph(G):
    """Returns True if G is a complete nxgraph."""
...
def _find_missing_edge(G):
    """ Given a non-complete nxgraph G, returns a missing edge."""
    nodes = set(G)
    for u in G:
...
def _find_chordality_breaker(G, s=None, treewidth_bound=sys.maxsize):
    """ Given a nxgraph G, starts a max cardinality search
    ...
    while unnumbered:  # and current_treewidth <= treewidth_bound:
        ...
        if _is_complete_graph(sg):
            # The nxgraph seems to be chordal by now. We update the treewidth
...
def _connected_chordal_graph_cliques(G):
    """Return the set of maximal cliques of a connected chordal nxgraph."""
