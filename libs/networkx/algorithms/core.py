...
def core_number(G):
    ...
    if G.number_of_selfloops() > 0:
        raise nx.NetworkXError(
            'Input nxgraph has self loops; the core number is not defined.',
...
def k_core(G, k=None, core_number=None):
    ...
    core_number : dictionary, optional
      Precomputed core numbers for the nxgraph G.
...
def k_crust(G, k=None, core_number=None):
    ...
    The k-crust is the nxgraph G with the k-core removed.
