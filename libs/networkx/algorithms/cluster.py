# -*- coding: utf-8 -*-
"""Algorithms to characterize the number of triangles in a nxgraph."""
...
def triangles(G, nodes=None):
    ...
    Notes
    -----
    When computing triangles for the entire nxgraph each triangle is counted
...
def average_clustering(G, nodes=None, weight=None, count_zeros=True):
    r"""Compute the average clustering coefficient for the nxgraph G.

    The clustering coefficient for the nxgraph is the average,
...
def transitivity(G):
    r"""Compute nxgraph transitivity, the fraction of all possible triangles
    present in G.
