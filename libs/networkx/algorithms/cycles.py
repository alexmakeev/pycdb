...
def cycle_basis(G, root=None):
    ...
    .. [1] Paton, K. An algorithm for finding a fundamental set of 
       cycles of a nxgraph. Comm. ACM 12, 9 (Sept 1969), 514-518.
...
def simple_cycles(G):
    """Find simple cycles (elementary circuits) of a directed nxgraph.
    ...
    References
    ----------
    .. [1] Finding all the elementary circuits of a directed nxgraph.
