...
def minimum_spanning_edges(G,weight='weight',data=True):
    ...
    A minimum spanning tree is a subgraph of the nxgraph (a tree)
    with the minimum sum of edge weights.  A spanning forest is a
    union of the spanning trees for each connected component of the nxgraph.
...
def minimum_spanning_tree(G,weight='weight'):
    ...
    A minimum spanning tree is a subgraph of the nxgraph (a tree) with
    the minimum sum of edge weights.

    If the nxgraph is not connected a spanning forest is constructed.  A
    spanning forest is a union of the spanning trees for each
    connected component of the nxgraph.
