...
def union(G, H, rename=(None, None), name=None):
    ...
    create_using : NetworkX nxgraph
       Use specified nxgraph for result.  Otherwise
    ...
    name : string
       Specify the name for the union nxgraph

    Returns
    -------
    U : A union nxgraph with the same type as G.
    ...
    to the union nxgraph.  If a nxgraph attribute is present in both
    ...
    # rename nxgraph to obtain disjoint node labels
    ...
    # add nxgraph attributes, H attributes take precedent over G attributes
...
def disjoint_union(G,H):
    ...
    Notes
    -----
    A new nxgraph is created, of the same class as G.  It is recommended
...
def intersection(G, H):
    ...
    ----------
    G,H : nxgraph
       A NetworkX nxgraph.  G and H must have the same node sets.

    Returns
    -------
    GH : A new nxgraph with the same type as G.

    Notes
    -----
    Attributes from the nxgraph, nodes, and edges are not copied to the new
    nxgraph.  If you want a new nxgraph of the intersection of G and H
...
def difference(G, H):
    """Return a new nxgraph that contains the edges that exist in G but not in H.
    ...
    Returns
    -------
    D : A new nxgraph with the same type as G.

    Notes
    -----
    Attributes from the nxgraph, nodes, and edges are not copied to the new
    nxgraph.  If you want a new nxgraph of the difference of G and H with
    with the attributes (including edge data) from G use remove_nodes_from()
    as follows:
...
def symmetric_difference(G, H):
    """Return new nxgraph with edges that exist in either G or H but not both.
...
def compose(G, H, name=None):
    """Return a new nxgraph of G composed with H.
    ...
    Returns
    -------
    C: A new nxgraph  with the same type as G
