...
# Generators for producting nxgraph products
...
def tensor_product(G,H):
    ...
    -------
    P: NetworkX nxgraph
     The tensor product of G and H. P will be a multi-nxgraph if either G
     or H is a multi-nxgraph. Will be a directed if G and H are directed,
...
def cartesian_product(G,H):
    ...
    -------
    P: NetworkX nxgraph
     The Cartesian product of G and H. P will be a multi-nxgraph if either G
     or H is a multi-nxgraph. Will be a directed if G and H are directed,
     and undirected if G and H are undirected.
