...
def attracting_components(G):
    ...
    An attracting component in a directed nxgraph `G` is a strongly connected
    component with the property that a random walker on the nxgraph will never
