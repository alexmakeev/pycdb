...
def strongly_connected_components(G):
    """Return nodes in strongly connected components of nxgraph.
    ...
    References
    ----------
    .. [1] Depth-first search and linear nxgraph algorithms, R. Tarjan
       SIAM Journal of Computing 1(2):146-160, (1972).

    .. [2] On finding the strongly connected components in a directed nxgraph.
...
def number_strongly_connected_components(G):
    """Return number of strongly connected components in nxgraph.
...
def is_strongly_connected(G):
    """Test directed nxgraph for strong connectivity.
    ...
    -------
    connected : bool
      True if the nxgraph is strongly connected, False otherwise.
...
def condensation(G, scc=None):
    ...
    The condensation of G is the nxgraph with each of the strongly connected
    ...
    the resulting nxgraph is a directed acyclic nxgraph.
    """
    if scc is None:
