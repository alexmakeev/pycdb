...
def degree_assortativity_coefficient(G, x='out', y='in', weight=None, 
    ...
    in the nxgraph with respect to the node degree.
    ...
    -------
    r : float
       Assortativity of nxgraph by degree.
...
def attribute_assortativity_coefficient(G,attribute,nodes=None):
    ...
    Assortativity measures the similarity of connections
    in the nxgraph with respect to the given attribute.
    ...
    -------
    r: float
       Assortativity of nxgraph for given attribute
...
def numeric_assortativity_coefficient(G, attribute, nodes=None):
    ...
    Assortativity measures the similarity of connections
    in the nxgraph with respect to the given numeric attribute.
