...
def is_distance_regular(G):
    ...
    A connected nxgraph G is distance-regular if for any nodes x,y
    and any integers i,j=0,1,...,d (where d is the nxgraph
    diameter), the number of vertices at distance i from x and
    distance j from y depends only on i,j and the nxgraph distance
    between x and y, independently of the choice of x and y.

    Parameters
    ----------
    G: Networkx nxgraph (undirected)

    Returns
    -------
    bool
      True if the nxgraph is Distance Regular, False otherwise
...
def global_parameters(b,c):
    ...
    Thus, a distance regular nxgraph has the global parameters,
...
def intersection_array(G):
    """Returns the intersection array of a distance-regular nxgraph.
    ...
    A distance regular nxgraph'sintersection array is given by,
