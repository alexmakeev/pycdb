...
def closeness_centrality(G, nodes, normalized=True):
    ...
    nxgraph or in the case that the nxgraph is not connected to all other nodes
    ...
    number of nodes in the connected part of nxgraph containing the
    node.  If the nxgraph is not completely connected, this algorithm
