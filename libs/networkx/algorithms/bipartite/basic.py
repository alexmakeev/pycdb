...
def biadjacency_matrix(G, row_order, column_order=None,
    ...
    r"""Return the biadjacency matrix of the bipartite nxgraph G.

    Let `G = (U, V, E)` be a bipartite nxgraph with node sets
    ...
    -------
    B : numpy matrix
      Biadjacency matrix representation of the bipartite nxgraph G.

    Notes
    -----
    No attempt is made to check that the input nxgraph is bipartite.
...
def color(G):
    """Returns a two-coloring of the nxgraph.

    Raises an exception if the nxgraph is not bipartite.
    ...
    Raises
    ------
    NetworkXError if the nxgraph is not two-colorable.
...
def is_bipartite(G):
    """ Returns True if nxgraph G is bipartite, False if not.
...
def sets(G):
    """Returns bipartite node sets of nxgraph G.
    ...
    (X,Y) : two-tuple of sets
       One set of nodes for each part of the bipartite nxgraph.
...
def density(B, nodes):
    """Return density of bipartite nxgraph B.
    ...
    nodes: list or container
      Nodes in one set of the bipartite nxgraph.
...
def degrees(B, nodes, weight=None):
    """Return the degrees of the two node sets in the bipartite nxgraph B.
