...
def average_clustering(G, nodes=None, mode='dot'):
    ...
    A clustering coefficient for the whole nxgraph is the average,
    ...
    nodes : list or iterable, optional
        ...
        The nodes should be either the entire nxgraph (the default) or one of the
        bipartite sets.
    ...
    clustering : float
       ...
       entire nxgraph if no nodes are specified.
