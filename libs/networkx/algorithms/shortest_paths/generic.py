# -*- coding: utf-8 -*-
"""
Compute the shortest paths and path lengths between nodes in the nxgraph.
...
def shortest_path_length(G, source=None, target=None, weight=None):
    """Compute shortest path lengths in the nxgraph.
...
def average_shortest_path_length(G, weight=None):
    ...
    ------
    NetworkXError:
       if the nxgraph is not connected.
...
def all_shortest_paths(G, source, target, weight=None):
    """Compute all shortest paths in the nxgraph.
