...
def closeness_centrality(G, v=None, distance=None, normalized=True):
    ...
    normalized : bool, optional      
      If True (default) normalize by the nxgraph size.
    ...
    n is the number of nodes in the connected part of nxgraph containing
    the node.  If the nxgraph is not completely connected, this
