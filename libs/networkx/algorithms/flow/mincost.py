...
def _initial_tree_solution(G, demand='demand', capacity='capacity',
    ...
    the nxgraph and call them artificial edges.
    """
...
def _create_flow_dict(G, H):
    """Creates the flow dict of dicts of nxgraph G with auxiliary nxgraph H."""
...
def network_simplex(G, demand='demand', capacity='capacity',
    ...
    demand: string
        Nodes of the nxgraph G are expected to have an attribute demand
    ...
    weight: string
        Edges of the nxgraph G are expected to have an attribute weight
    ...
    ------
    NetworkXError
        This exception is raised if the input nxgraph is not directed,
    ...
    if not G.is_directed():
        raise nx.NetworkXError("Undirected nxgraph not supported.")
...
def min_cost_flow_cost(G, demand='demand', capacity='capacity',
    ...
    ------
    NetworkXError
        This exception is raised if the input nxgraph is not directed or
        not connected.
...
def cost_of_flow(G, flowDict, weight='weight'):
    ...
    flow flowDict. This function will fail if the nxgraph G and the
