...
class TestMaxflow:
    ...
    def test_graph2(self):
        # A more complex undirected nxgraph
    ...
    def test_digraph1(self):
        # The classic directed nxgraph example
        G = nx.DiGraph()
    ...
    def test_digraph2(self):
        # A directed nxgraph example from Cormen et al.
        G = nx.DiGraph()
    ...
    def test_digraph3(self):
        # A more complex directed nxgraph
    ...
    def test_graph_infcap_edges(self):
        # Undirected nxgraph with infinite capacity edges
        G = nx.Graph()
        G.add_edge('s', 'a')
        G.add_edge('s', 'b', capacity=30)
        G.add_edge('a', 'c', capacity=25)
