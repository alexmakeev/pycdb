...
def pagerank(G, alpha=0.85, personalization=None,
    ...
    """Return the PageRank of the nodes in the nxgraph.

    PageRank computes a ranking of the nodes in the nxgraph G based on
    ...
    personalization: dict, optional
       ...
       key for every nxgraph node and nonzero personalization value for each node.
    ...
    algorithm does not check if the input nxgraph is directed and will
    execute on undirected graphs by converting each oriented edge in the
    directed nxgraph to two edges.
...
def google_matrix(G, alpha=0.85, personalization=None,
    ...
    """Return the Google matrix of the nxgraph.
