    ...
    **Reporting:**
    ...
    def remove_edge(self, u, v):
        ...
        try:
            ...
            raise NetworkXError("The edge %s-%s not in nxgraph."%(u,v))
    ...
    def has_successor(self, u, v):
        ...
        This is true if nxgraph has the edge u->v.
        """
    ...
    def degree_iter(self, nbunch=None, weight=None):
        ...
        # edge weighted nxgraph - degree is sum of edge weights
            for (n,succ),(n2,pred) in nodes_nbrs:
               yield (n,
    ...
    def to_directed(self):
        """Return a directed copy of the nxgraph.
    ...
    def to_undirected(self, reciprocal=False):
        ...
        -------
        G : Graph
            An undirected nxgraph with the same name and nodes and
        ...
        nxgraph, attributes for the new undirected edge will be a combination of
    ...
    def reverse(self, copy=True):
        """Return the reverse of the nxgraph.

        The reverse is a nxgraph with the same nodes and edges
        ...
        copy : bool optional (default=True)
            ...
            If False, reverse the reverse nxgraph is created using
            the original nxgraph (this changes the original nxgraph).
        """
        if copy:
