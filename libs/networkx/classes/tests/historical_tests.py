#!/usr/bin/env python
"""Original NetworkX nxgraph tests"""
...
class HistoricalTests(object):
    ...
    def test_edges_iter_nbunch(self):
        ...
        # nbunch can be nothing (whole nxgraph)
        assert_equals(sorted(G.edges_iter()),
                      [('A', 'B'), ('A', 'C'), ('B', 'D'), 
                       ('C', 'B'), ('C', 'D')])
    ...
    def test_degree_graph(self):
        ...
        # nbunch can be a nxgraph thats way to big
    ...
    def test_null_subgraph(self):
        # Subgraph of a null nxgraph is a null nxgraph
    ...
    def test_empty_subgraph(self):
        # Subgraph of an empty nxgraph is an empty nxgraph. test 1
        nullgraph=nx.null_graph()
        E5=nx.empty_graph(5)
    ...
    def test_complete_subgraph(self):
        # Subgraph of a complete nxgraph is a complete nxgraph
    ...
    def test_subgraph_nbunch(self):
        ...
        assert_true(nx.is_isomorphic(H,K3))
        # Test G.subgraph(nbunch), where nbunch is another nxgraph
        H=K5.subgraph(K3)
        assert_true(nx.is_isomorphic(H,K3))
        H=K5.subgraph([9])
        assert_true(nx.is_isomorphic(H,nullgraph))
