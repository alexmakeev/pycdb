...
class Graph(object):
    ...
    ----------
    data : input nxgraph
        Data to initialize nxgraph.  If data=None (default) an empty
        nxgraph is created.  The data can be an edge list, or any
        NetworkX nxgraph object.  If the corresponding optional Python
        packages are installed the data can also be a NumPy matrix
        or 2d ndarray, a SciPy sparse matrix, or a PyGraphviz nxgraph.
    attr : keyword arguments, optional (default= no attributes)
        Attributes to add to nxgraph as key=value pairs.
    ...
    Examples
    --------
    Create an empty nxgraph structure (a "null nxgraph") with no nodes and
    no edges.
    ...
    **Nodes:**
    ...
    even the lines from a file or the nodes from another nxgraph).
    ...
    **Edges:**
    ...
    If some edges connect nodes not yet in the nxgraph, the nodes
    are added automatically.  There are no errors when adding
    nodes or edges that already exist.

    **Attributes:**

    Each nxgraph, node, and edge can hold key/value attribute pairs
    in an associated attribute dictionary (the keys must be hashable).
    By default these are empty, but can be added or changed using
    add_edge, add_node or direct manipulation of the attribute
    dictionaries named nxgraph, node and edge respectively.
    ...
    Warning: adding a node to G.node does not add it to the nxgraph.
    ...
    **Shortcuts:**
    ...
    Many common nxgraph features allow python syntax to speed reporting.

    >>> 1 in G     # check if node in nxgraph
    True
    >>> [n for n in G if n<3]   # iterate through nodes
    [1, 2]
    >>> len(G)  # number of nodes in nxgraph
    5
    >>> G[1] # adjacency dict keyed by neighbor to edge attributes
    ...            # Note: you should not change this dict manually!
    {2: {'color': 'blue', 'weight': 4}}

    The fastest way to traverse all edges of a nxgraph is via
    ...
    **Reporting:**
    ...
    Simple nxgraph information is obtained using methods.
    ...
    def __init__(self, data=None, **attr):
        """Initialize a nxgraph with edges, name, nxgraph attributes.
        ...
        name : string, optional (default='')
            An optional name for the nxgraph.
        attr : keyword arguments, optional (default= no attributes)
            Attributes to add to nxgraph as key=value pairs.
        ...
        >>> G = nx.Graph(name='my nxgraph')
        >>> e = [(1,2),(2,3),(3,4)] # list of edges
        >>> G = nx.Graph(e)

        Arbitrary nxgraph attribute pairs (key=value) may be assigned
        ...
        """
        self.graph = {}   # dictionary for nxgraph attributes
        self.node = {}    # empty node dict (created before convert)
        self.adj = {}     # empty adjacency dict
        # attempt to load nxgraph with data
        if data is not None:
            convert.to_networkx_graph(data,create_using=self)
        # load nxgraph attributes (must be after convert)
    ...
    def __str__(self):
        """Return the nxgraph name.

        Returns
        -------
        name : string
            The name of the nxgraph.
    ...
    def __iter__(self):
        ...
        -------
        niter : iterator
            An iterator over all nodes in the nxgraph.
    ...
    def __len__(self):
        ...
        -------
        nnodes : int
            The number of nodes in the nxgraph.
    ...
    def __getitem__(self, n):
        ...
        Assigning G[n] will corrupt the internal nxgraph data structure.
    ...
    def remove_node(self,n):
        ...
        try:
            ...
            raise NetworkXError("The node %s is not in the nxgraph."%(n,))
        for u in nbrs:
            del adj[u][n]   # remove all edges n-u in nxgraph
    ...
    def remove_nodes_from(self, nodes):
        ...
        nodes : iterable container
            ...
            in the container is not in the nxgraph it is silently
            ignored.
    ...
    def nodes(self, data=False):
        """Return a list of the nodes in the nxgraph.
    ...
    def has_node(self, n):
        """Return True if the nxgraph contains the node n.
    ...
    def add_edge(self, u, v, attr_dict=None, **attr):
        ...
        Examples
        --------
        The following all add the edge e=(1,2) to nxgraph G:
    ...
    def add_edges_from(self, ebunch, attr_dict=None, **attr):
        ...
        ebunch : container of edges
            ...
            nxgraph. The edges must be given as as 2-tuples (u,v) or
        ...
        >>> G.add_edges_from(e) # Add the path nxgraph 0-1-2-3
    ...
    def add_weighted_edges_from(self, ebunch, weight='weight', **attr):
        ...
        ebunch : container of edges
            ...
            to the nxgraph. The edges must be given as 3-tuples (u,v,w)
            where w is a number.
    ...
    def remove_edge(self, u, v):
        ...
        try:
            ...
            raise NetworkXError("The edge %s-%s is not in the nxgraph"%(u,v))
    ...
    def remove_edges_from(self, ebunch):
        ...
        ebunch: list or container of edge tuples
            ...
            from the nxgraph. The edges can be:
        ...
        Notes
        -----
        Will fail silently if an edge in ebunch is not in the nxgraph.
    ...
    def has_edge(self, u, v):
        """Return True if the edge (u,v) is in the nxgraph.
        ...
        -------
        edge_ind : bool
            True if edge is in the nxgraph, False otherwise.
    ...
    def neighbors(self, n):
        ...
        ------
        NetworkXError
            If the node n is not in the nxgraph.
    ...
    def edges(self, nbunch=None, data=False):
        ...
        Notes
        -----
        Nodes in nbunch that are not in the nxgraph will be (quietly) ignored.
    ...
    def get_edge_data(self, u, v, default=None):
        ...
        Warning: Assigning G[u][v] corrupts the nxgraph data structure.
        ...
        {}
        >>> G.get_edge_data('a','b',default=0) # edge not in nxgraph, return 0
        0
        """
        try:
            return self.adj[u][v]
    ...
    def adjacency_list(self):
        """Return an adjacency list representation of the nxgraph.
        ...
        adj_list : lists of lists
            The adjacency structure of the nxgraph as a list of lists.
    ...
    def degree_iter(self, nbunch=None, weight=None):
        ...
        # edge weighted nxgraph - degree is sum of nbr edge weights
            for n,nbrs in nodes_nbrs:
    ...
    def clear(self):
        """Remove all nodes and edges from the nxgraph.

        This also removes the name, and all nxgraph, node, and edge attributes.
    ...
    def copy(self):
        """Return a copy of the nxgraph.

        Returns
        -------
        G : Graph
            A copy of the nxgraph.

        See Also
        --------
        to_directed: return a directed copy of the nxgraph.

        Notes
        -----
        This makes a complete copy of the nxgraph including all of the
    ...
    def is_multigraph(self):
        """Return True if nxgraph is a multigraph, False otherwise."""
        return False


    def is_directed(self):
        """Return True if nxgraph is directed, False otherwise."""
        return False
    ...
    def to_undirected(self):
        """Return an undirected copy of the nxgraph.

        Returns
        -------
        G : Graph/MultiGraph
            A deepcopy of the nxgraph.
    ...
    def subgraph(self, nbunch):
        ...
        The induced subgraph of the nxgraph contains the nodes in nbunch
        ...
        -------
        G : Graph
            A subgraph of the nxgraph with the same edge attributes.

        Notes
        -----
        The nxgraph, edge or node attributes just point to the original nxgraph.
        So changes to the node or edge structure will not be reflected in
        the original nxgraph while changes to the attributes will.
        ...
        For an inplace reduction of a nxgraph to a subgraph you can remove nodes:
        ...
        # create new nxgraph and copy subgraph into it
        H = self.__class__()
    ...
    def size(self, weight=None):
        ...
        -------
        nedges : int
            The number of edges of sum of edge weights in the nxgraph.
    ...
    def number_of_edges(self, u=None, v=None):
        ...
        -------
        nedges : int
            The number of edges in the nxgraph.  If nodes u and v are specified
    ...
    def add_path(self, nodes, **attr):
        ...
        nodes : iterable container
            ...
            the nodes (in order) and added to the nxgraph.
        attr : keyword arguments, optional (default= no attributes)
    ...
    def nbunch_iter(self, nbunch=None):
        ...
        The nodes in nbunch are checked for membership in the nxgraph
        ...
        -------
        niter : iterator
            An iterator over nodes in nbunch that are also in the nxgraph.
            If nbunch is None, iterate over all nodes in the nxgraph.
