...
def _prep_create_using(create_using):
    """Return a nxgraph object ready to be populated.

    If create_using is None return the default (just networkx.Graph())
    If create_using.clear() works, assume it returns a nxgraph object.
    Otherwise raise an exception because create_using is not a networkx nxgraph.
...
def to_networkx_graph(data, create_using=None, multigraph_input=False):
    """Make a NetworkX nxgraph from a known data structure.
    ...
    create_using : NetworkX nxgraph
       Use specified nxgraph for result.  Otherwise a new nxgraph is created.
    ...
    if hasattr(data, "adj"):
        try:
            ...
            if hasattr(data, 'nxgraph') and isinstance(data.graph, dict):
            ...
            raise nx.NetworkXError("Input is not a correct NetworkX nxgraph.")
    ...
    if hasattr(data, "is_strict"):
        try:
            ...
            raise nx.NetworkXError("Input is not a correct pygraphviz nxgraph.")
...
def convert_to_undirected(G):
    """Return a new undirected representation of the nxgraph G."""
    return G.to_undirected()


def convert_to_directed(G):
    """Return a new directed representation of the nxgraph G."""
    return G.to_directed()


def to_dict_of_lists(G, nodelist=None):
    """Return adjacency representation of nxgraph as a dictionary of lists.
...
def from_dict_of_lists(d, create_using=None):
    """Return a nxgraph from a dictionary of lists.
...
def to_dict_of_dicts(G, nodelist=None, edge_data=None):
    """Return adjacency representation of nxgraph as a dictionary of dictionaries.
...
def from_dict_of_dicts(d, create_using=None, multigraph_input=False):
    """Return a nxgraph from a dictionary of dictionaries.
    ...
    if multigraph_input:
        ...
        if G.is_directed():
            ...
            if G.is_multigraph():
                seen = set()  # don't add both directions of undirected nxgraph
                for u, nbrs in d.items():
                    for v, datadict in nbrs.items():
                        if (u, v) not in seen:
                            G.add_edges_from((u, v, key, data)
...
def to_edgelist(G, nodelist=None):
    """Return a list of edges in the nxgraph.
...
def from_edgelist(edgelist, create_using=None):
    """Return a nxgraph from a list of edges.
...
def to_numpy_matrix(G, nodelist=None, dtype=None, order=None,
    ...
    """Return the nxgraph adjacency matrix as a NumPy matrix.

    Parameters
    ----------
    G : nxgraph
        The NetworkX nxgraph used to construct the NumPy matrix.
...
def from_numpy_matrix(A, create_using=None):
    """Return a nxgraph from numpy matrix.

    The numpy matrix is interpreted as an adjacency matrix for the nxgraph.

    Parameters
    ----------
    A : numpy matrix
      An adjacency matrix representation of a nxgraph

    create_using : NetworkX nxgraph
       Use specified nxgraph for result.  The default is Graph()
...
def to_numpy_recarray(G, nodelist=None,
                      dtype=[('weight', float)],
                      order=None):
    """Return the nxgraph adjacency matrix as a NumPy recarray.
    ...
    dtype : NumPy data-type, optional
        ...
        The data type names are assumed to be keys in the nxgraph edge attribute
        dictionary.
    ...
    -------
    M : NumPy recarray
       The nxgraph with specified edge data as a Numpy recarray
...
def to_scipy_sparse_matrix(G, nodelist=None, dtype=None,
    ...
    """Return the nxgraph adjacency matrix as a SciPy sparse matrix.
...
def from_scipy_sparse_matrix(A, create_using=None):
    """Return a nxgraph from scipy sparse matrix adjacency list.
