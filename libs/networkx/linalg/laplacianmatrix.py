...
def laplacian_matrix(G, nodelist=None, weight='weight'):
    ...
    The nxgraph Laplacian is the matrix L = D - A, where
...
def normalized_laplacian_matrix(G, nodelist=None, weight='weight'):
    ...
    The normalized nxgraph Laplacian is the matrix
    
    .. math::
        
        NL = D^{-1/2} L D^{-1/2}

    where `L` is the nxgraph Laplacian and `D` is the diagonal matrix of
    node degrees.
