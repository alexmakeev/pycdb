...
def attr_matrix(G, edge_attr=None, node_attr=None, normalized=False, 
    ...
    edge_attr : str, optional
        ...
        all edges in the nxgraph. If no attribute is specified, then we
    ...
    node_attr : str, optional
        ...
        in the nxgraph. Note, the values of this attribute should be reliably
        hashable. So, float values are not recommended. If no attribute is 
        specified, then the rows and columns will be the nodes of the nxgraph.
    ...
    Thus, the total weight over all edges (u,v) with u and v having colors:
        ...
        (blue, red)  is 2   # same as (red, blue) since nxgraph is undirected
