...
urlpatterns = patterns('',
                       ...
                       url(r'^getObjAttributes/(?P<cid>\d+)/(?P<id>\d+)$', 'interface_1ka.views.getObjAttributes',
                           name="views-object-attributes"),
                       url(r'^getRelAttributes/(?P<cid>\d+)/(?P<id>\d+)$', 'interface_1ka.views.getRelAttributes',
                           name="views-rel-attributes"),
                       url(r'^deleteNode/(?P<cid>\d+)/(?P<id>\d+)$', 'interface_1ka.views.deleteNode',
                           name="views-delete-node"),
                       url(r'^deleteRelation/(?P<cid>\d+)/(?P<id>\d+)$', 'interface_1ka.views.deleteRelation',
